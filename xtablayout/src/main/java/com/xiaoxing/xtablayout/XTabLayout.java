package com.xiaoxing.xtablayout;
...
public class XTabLayout extends HorizontalScrollView {
   ...
   /*     TypedArray a = context.obtainStyledAttributes(attrs, android.support.design.R.styleable.TabLayout,
    ...
    public void setSelectedTabIndicatorWidth(int height) {
        mTabStrip.setmSelectedIndicatorWidth(height);
    }

    public float getSelectedTabTextSize() {
        return mTabSelectedTextSize;
    }
    ...
    void selectTab(Tab tab, boolean updateIndicator) {
        setSelectedTabIndicatorWidth(tab.getText().toString());
        if (mSelectedTab == tab) {
     ...
     * @param tabContent
     */
    private void setSelectedTabIndicatorWidth(String tabContent) {

        setSelectedTabIndicatorWidth(getCharacterWidth(tabContent, getSelectedTabTextSize()));
